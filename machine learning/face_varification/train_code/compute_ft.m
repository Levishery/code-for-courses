...
% save 5 images with the biggest reconstruction residual

clc;
clear
path = '/Users/janechen/Desktop/feature_test/';
G_path = '/Users/janechen/Desktop/G/';
...
for i=1:sample_num
    ...
    data_result = [data_result, sum(abs(reduced_data1 - reduced_data2))];
end

match = data_result(:,1:300);
mismatch = data_result(:,301:600);

save([result_path '1.mat'], 'match');
save([result_path '0.mat'], 'mismatch');
